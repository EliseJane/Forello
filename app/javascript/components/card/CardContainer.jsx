...
class CardContainer extends React.Component {
  ...
  componentDidMount() {
    ...
    store.dispatch(actions.fetchCard(
      this.props.match.params.id,
      (card) => { this.setCardState(card) }
    ));
  }
  ...
  fetchBoardState = () => {
    this.context.store.dispatch(fetchBoard(
      +this.state.card.board_id,
      (board) => { this.setBoardState(board) }
    ));
  }
  ...
  getListTitle = () => {
    const listId = this.state.card.list_id;
    const lists = this.state.board.lists;
  ...
  deleteCard = () => {
    this.context.store.dispatch(actions.deleteCard(this.state.card));
  }

  render() {
    if (this.state.card && this.state.board) {
      return (
        <div id="modal-container">
          ...
          <Card
            ...
            updateArchived={this.updateArchived}
...
//     <div class="archived-banner"><i class="file-icon icon"></i>This card is archived.</div>
//     <header>
...
//             <li>
//               <div class="member-container">
//                 <div class="card-member small-size">EO</div>
//               </div>
//               <p><span class="member-name">Elise Olivares</span> changed the background of this board <small>yesterday at 4:53 PM</small>
//               </p>
//             </li>
//             <li class="activity-comment">
//               <div class="member-container">
//                 <div class="card-member">EO</div>
//               </div>
...
//         </li>
//         <hr>
//         <li class="unarchive-button"><i class="send-icon sm-icon"></i>Send to board</li>
